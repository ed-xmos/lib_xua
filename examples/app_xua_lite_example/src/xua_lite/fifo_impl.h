...
void fifo_reset_fill(volatile mem_fifo_t * unsafe fifo, unsigned fill /*in samples*/, unsigned subslot_size) {
    unsafe {
        fifo->read_idx = 0;
        fifo->write_idx = fill;
...
static inline void fifo_init(volatile mem_fifo_t * unsafe fifo, unsigned subslot_size) {
    unsafe{
        fifo->write_idx = 0;
...
static inline fifo_ret_t fifo_block_push_fast(volatile mem_fifo_t * unsafe fifo, int8_t data[], unsigned n, unsigned subslot_size) {
    unsafe{
...
#pragma unsafe arrays
static inline fifo_ret_t fifo_block_pop_fast(volatile mem_fifo_t * unsafe fifo, int8_t data[], unsigned n, unsigned subslot_size) {
    unsafe{
