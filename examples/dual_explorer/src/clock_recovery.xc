...
int16_t calc_frequency_error(uint32_t sample_rate, uint32_t sample_rate_2, uint16_t mclk_count, uint16_t mclk_count_2)
{
    ...
    int16_t f_error = mclk_count - expected_mclk_count;
    int16_t f_error_2 = mclk_count_2 - expected_mclk_count_2;
        ...
        while(mclk_rate_same)
        {
            ...
            select
            {
                case tmr when timerafter(time_trigger) :> int _:
                    uint32_t mclk_count, mclk_count_2;
                    ...
                    printintln(mclk_count);
                    printintln(mclk_count_2);
