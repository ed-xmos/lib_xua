...
extern void XUA_Endpoint0_2(  chanend c_ep0_out,
                            chanend c_ep0_in,
...
void XUA_Endpoint0_wrapper( chanend c_ep0_out,
                            ...
                            NULLABLE_RESOURCE(chanend, dfuInterface))
{
    XUA_Endpoint0_2(c_ep0_out, c_ep0_in, c_audioCtrl, c_mix_ctl, c_clk_ctl, c_EANativeTransport_ctrl, dfuInterface);
}

// XUA does not currently allow C to call XUA_Buffer
void XUA_Buffer_2(chanend c_ep_out_1,
                chanend c_ep_in_2,
                chanend c_ep_in_1,
                chanend c_sof,
                chanend c_aud_ctl,
...
void XUA_Buffer_wrapper(chanend c_ep_out_1,
                        ...
                        chanend c_aud)
{
    XUA_Buffer_2(c_ep_out_1, c_ep_in_2, c_ep_in_1, c_sof, c_aud_ctl, p_for_mclk_count, c_aud);
}

// XUA does not currently allow C to call XUA_AudioHub
void XUA_AudioHub_2(chanend c_aud,
...
void XUA_AudioHub_wrapper(  chanend c_aud,
                            ...
                            in_buffered_port_32_t p_i2s_adc[])
{
    XUA_AudioHub_2(c_aud, clk_audio_mclk, clk_audio_bclk, p_mclk_in, p_lrclk, p_bclk, p_i2s_dac, p_i2s_adc);
}
